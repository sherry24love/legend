    ...
    <ul class="aui-list aui-form-list">
    	<li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input" >
                	<input type="text" placeholder="请输入持卡人姓名" id="name" value="{{$bank->name}}" />
                </div>
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input" >
                    <input type="text" placeholder="请输入银行卡号" id="card_no" value="{{$bank->card_no}}" />
                </div>
                <div class="aui-list-item-label aui-font-size-12">
...
$('#save').click(function(){
	...
	$.ajax({
		url:"{{route('wap.bank.edit' , ['id' => $bank->id ])}}" ,
		type:"post" ,
		data:{
			name:name ,
			bank_id:bank_id ,
