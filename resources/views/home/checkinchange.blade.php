    ...
    <form id="checkin" method="post" class="form-horizontal" action="">
                    ...
                    <table class="table">
                        ...
                        <tbody class="goods_info">
                            <tr class="good_style3" height="35">
                                ...
                                <td>
                                    <input type="text" class="form-control package_type" placeholder="必填" name="goods[package]" maxlength="10" 
		...
		<div class="entrust checkin-create">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control n-key" name="entrust[name]" id="entrust_fullname" maxlength="30" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control n-key" name="entrust[contact]" id="entrust_contactname" maxlength="30" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control n-key" type="text" name="entrust[mobile]" id="entrust_mobile" maxlength="11" 
		...
		<div class="sender checkin-create">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="sender[name]" id="sender_fullname" class="form-control" placeholder="公司名称/个人姓名" maxlength="50" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="sender[contact_name]" class="form-control" id="sender_contactname" maxlength="50" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control n-key" name="sender[mobile]" id="sender_mobile" maxlength="14" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" name="sender[email]" id="sender_email" maxlength="25" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" name="sender[address]" id="sender_address" maxlength="25"  value="{{data_get( data_get( $order , 'sender') , 'address' )}}" 
					>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="sender_date" type="text" readonly="" data-date-format="yyyy-mm-dd" class="date form-control datepicker" name="sender[load_date]" value="{{ str_limit( data_get( data_get( $order , 'sender') , 'load_date' ) , 10 , '' )}}">
				</div>
			</div>
		</div>
		...
		<div class="recevier checkin-create">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="recevier[name]" class="form-control" id="recevier_fullname" placeholder="收货公司/个人真实姓名" maxlength="50" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="recevier[contact_name]" class="form-control n-key" id="recevier_contactname" maxlength="50" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="recevier[mobile]" class="form-control n-key" id="recevier_mobile" maxlength="14" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="recevier_email" class="form-control n-key" name="recevier[email]" maxlength="25" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="recevier_address" class="form-control" placeholder="到门柜收货地址必填" name="recevier[address]" maxlength="25" 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="recevier_id_no" placeholder="" name="recevier[id_no]" maxlength="25" 
		...
		<div class="div04">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<textarea class="form-control" placeholder="请填写备注">{!!$order->remark or ''!!}</textarea>
				</div>
			</div>
		</div>
		<div class="bs-callout bs-callout-info" id="callout-type-b-i-elems">
		...
		<div class="div04">
			<div class="form-group">
				...
				<div class="col-sm-4 radio">
					<label class="radio-inline">
						<input type="radio" name="enable_ensure" value="1" @if( data_get( $order ,'enable_ensure' ) == 1 ) checked @endif >购买
					</label>
					<label class="radio-inline">
						<input type="radio" name="enable_ensure" value="2" @if( data_get( $order ,'enable_ensure' ) == 2 ) checked @endif  >不需要
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="ensure_name" class="form-control" id="insure_name" maxlength="20" 
...
$(document).ready(function(){
	...
	$('#sub_wts').on('click' , function(){
		...
		**/
		if( $('input[name="enable_ensure"]:checked').length == 0 ) {
			layer.msg('请选择是否需要保险!') ;
			return false ;
		}
		...
		//提示是否要加入模板
		layer.confirm("您确定要提交修改申请吗" , function( index ){
			layer.close( index );
			checkin();
		} );
