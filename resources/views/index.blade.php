...
<link rel="stylesheet" href="{{asset('nim/im/css/animate.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/jquery-ui.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/contextMenu/jquery.contextMenu.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/minAlert.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/uiKit.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/CEmojiEngine.css')}}"/>
<link rel="stylesheet" href="{{asset('nim/im/css/rangeslider.css')}}"/>
</head>
<body>
...
<div class="aui-tab" id="tab" style="position:fixed;top:2.25rem;width: 100%;z-index:9999">
    <a class="aui-tab-item aui-active">患者资料</a>
    <a class="aui-tab-item" href="javascript:void(0);" id="sendOrder">诊断开方</a>
</div>
